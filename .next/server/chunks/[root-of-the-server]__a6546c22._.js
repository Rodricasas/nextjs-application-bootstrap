...
async function GET() {
    try {
        const tickets = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].ticket.findMany({
            orderBy: {
                created_at: 'desc'
            }
        });
...
async function POST(request) {
    try {
        ...
        const ticket = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].ticket.create({
            data: ticketData
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            data: ticket
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a6546c22._.js.map